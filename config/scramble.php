...
return [
    ...
    'servers' => [
        ...
        'Development' => 'https://dev-api.glorytogloryfortune.com/api',
        'Production' => 'https://api.glorytogloryfortune.com/api',
    ],

    // Add security schemes for API Key and Sanctum Bearer token
    'securitySchemes' => [
        'ApiKeyAuth' => [
            'type' => 'apiKey',
            'in' => 'header',
            'name' => 'X-API-KEY', // Change if your header is different
        ],
        'SanctumAuth' => [
            'type' => 'http',
            'scheme' => 'bearer',
    ...
    // Set default security to require API key
    'security' => [
        ['ApiKeyAuth' => []],
    ],
